...
class HistoryAdapter(
  ...
  fun toggleSelectAll() {
    if (selectedItems.size == currentList.size) {
      ...
      selectedItems.clear()
      currentList.forEach { scanResult -> selectedItems.add(scanResult.id) }
  ...
  override fun onBindViewHolder(holder: ViewHolder, position: Int) {
    ...
    holder.itemView.setOnClickListener { onItemClickSimple?.invoke(scanResult) }

    holder.binding.deleteButton.setOnClickListener { onDelete(scanResult) }
  }
